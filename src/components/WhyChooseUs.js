...
const WhyChooseUs = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Why Choose USECTA | Leading Pharmaceutical Materials Provider</title>
        <meta 
          name="description" 
          content="Learn why USECTA is the preferred choice for pharmaceutical raw materials in Sri Lanka. Quality assurance, reliable supply chain, and expert support for your pharmaceutical needs."
        />
        <link rel="canonical" href="/why-choose-us" />
      </Helmet>
