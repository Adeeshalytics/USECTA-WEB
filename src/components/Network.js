...
const USECTANetworkPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Network - USECTA | Global Pharmaceutical Supply Chain</title>
        <meta 
          name="description" 
          content="Discover USECTA's global network of pharmaceutical suppliers and partners. We ensure reliable supply chains and quality materials for our clients worldwide."
        />
        <link rel="canonical" href="/network" />
      </Helmet>
